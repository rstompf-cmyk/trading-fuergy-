...
git add app.py livesim.py vdt_state.py vdt_optimizer.py vdt_live_advisor.py vdt_pair_matcher.py \
        optimizer.py core/effect_db.py core/rt_audit.py core/caches.py core/holidays_skcz.py core/feasibility.py core/soc_source.py core/soc_use_audit.py scheduler.py price_model_15m.py price_model.py d1_planner.py cdc.py report.py \
        ...
        tests/test_vdt_soc_feasible.py tests/test_holidays_skcz.py tests/test_feasibility_parity.py tests/test_soc_source.py tests/test_feasibility_gate_extras.py tests/test_vdt_absolute_audit.py \
